...
const About = () => {
  return (
    <div className="py-6 px-4 pt-14 sm:px-8 md:pt-16 lg:max-w-7xl lg:mx-auto">
      <div>
        <h1 className="text-3xl heading-white font-head pb-6 font-medium sm:text-4xl lg:text-5xl">
          Who are we?
        </h1>
      </div>
      <p className="text-sm text-fontWhite pb-2 leading-6 sm:text-base lg:text-lg">
      ...
      <p className="text-sm pb-2 text-fontWhite leading-6 sm:text-base  lg:text-lg">
        {" "}
      ...
      <div className="text-fontWhite sm:grid sm:grid-cols-2 gap-5 md:mt-10 lg:px-20 lg:gap-x-20">
        <div className="text-center  border border-gray-200 rounded-md shadow-md mb-4 py-4 px-6  ">
          ...
          <h1 className="font-head text-primary font-medium inline-block text-2xl line ">
            Express Delivery
          </h1>
