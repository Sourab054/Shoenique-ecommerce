...
const About = () => {
  return (
    <div className="py-6 px-4 text-fontWhite sm:px-8 md:pt-12 md:mt-20 lg:max-w-7xl lg:mx-auto">
      <div>
        <h1 className="text-3xl text-white heading-white font-head pb-6 font-medium sm:text-4xl lg:text-5xl">
          Who are we?
        </h1>
      </div>
      <p className="text-sm font-medium pb-2 leading-6 sm:text-base lg:text-lg">
      ...
      <p className="text-sm pb-2 font-medium  leading-6 sm:text-base md:leading-none lg:text-lg">
        {" "}
      ...
      <div className="sm:grid sm:grid-cols-2 gap-5 md:mt-10 lg:px-20 lg:gap-x-20">
        <div className="text-center border border-primary rounded-md shadow-md mb-4 py-4 px-6  ">
          <div className="grid place-content-center pb-2 text-tertiary">
            <FaTruckMoving size="50" />
          </div>
          <h1 className="font-head text-white inline-block text-2xl line ">
            Express Delivery
          </h1>
